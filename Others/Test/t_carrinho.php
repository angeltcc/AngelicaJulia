	...
	<header>  
        <div class="container" id="nav-container">
            <nav class="navbar navbar-expand-lg fixed-top">
                ...
                <!--abrir modal login-->
                <div class="dropend">
                <button type="image" style="margin-right: 1.5rem; margin-left: 1.5rem;" class="flex-shrink-0 order-lg-1 mx-auto ms-lg-0 pe-lg-2 me-lg-2" data-bs-toggle="dropdown" aria-expanded="false">
                <img src="../Images/Icons/icons8-usuário-de-gênero-neutro-100.png" height="40" width="40">
                </button>

                <ul class="dropdown-menu">
                    <li><button class="dropdown-item" type="button" data-bs-toggle="modal" style="margin-left: -20px;" data-bs-target="#loginmodal">Login</button></li>

                    <li><button class="dropdown-item" type="button" data-bs-toggle="modal" style="margin-left: -20px;" data-bs-target="#cadastromodal">Cadastro</button></li>
                ...
                <!-- formulario -->
                    <form id="login-usuario-form" method="post">
                        ...
                        <input type="submit" name="btnlogin" value="Entrar" class="button-submit">
                            ...
                            <input class="form-control form-control-lg" placeholder="Senha" aria-label=".form-control-lg example" type="password" name="senha" maxlength="32" <!--="" checkbox="" --="">
                    <div class="container-p">
                        <input class="form-check-input" type="checkbox" value="" id="loginCheck" checked="">
