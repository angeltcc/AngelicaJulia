        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container fixed-center">
                    ...
                    <img style="width: 150px;" src="../Images/fantasmazul.png" />
                    </div>
                    ...
                    <form method="post">
                        ...
                        <div class="mb-4">
                            <input class="form-control form-control-lg" placeholder="RG" aria-label=".form-control-lg example" type="text" name="RG" maxlength="15" onkeypress="$(this).mask('000000000000000');" / required>
                        </div>
                        <div class="mb-4">
...
if (isset($_POST['btnsignup'])) {
    ...
    if (empty($nome) || empty($telefone) || empty($CPF) || empty($RG) || empty($email) || empty($usuario) || empty($senha) || empty($senha2)) {
