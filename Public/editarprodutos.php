...
<html lang="pt-br">
    ...
    <!-- botao pesquisa -->
        <?php if (isset($_POST['botaobusca'])){
            ...
            <button type="image">
                    <img id="adicionar" src="../Images/iconadicionarbranco.png">
                </button>
            </a>
            </div>
                    <?php foreach ($tb_produtos as $p) { ?>
                        <div class="content">
                    <button data-bs-toggle="modal" data-bs-target="#warning"><img class="produto" src="<?php echo $p['imagem']; ?>"></button>
                    ...
                    <div class="cor">
                       <!-- <a href="view-editprod.php?id=<?php //echo $p['id_produto']; ?>" ><button class="buy">editar</button></a> -->
                        <div class="btn-group">
                            ...
                            <button type="button" name="delete" class="alterar">
    ...
    if (isset($_GET['delete'])){
        ...
        if ($stmt->execute()) {
            ...
            header("Refresh: 3;url=concategoria.php");
        } else {
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-body">
            <p class="text-dark">Tem certeza que deseja excluir <?php // echo $p['nome_produto']?> ?</p>
        </div>
        <div class="modal-footer">
        <form method="post">
            <button type="button" name="excluir" class="btn btn-secondary">Sim</button>
        </form>
...
/*    if (isset($_POST['excluir'])){
        $sql = "DELETE FROM tb_produtos WHERE id_produto = 11";
        $stmt = $pdo->prepare($sql);
        $stmt->execute; 
    }*/
    ?>
